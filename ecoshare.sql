...
CREATE TABLE doacoes (
  ...
  tipo_material ENUM('metal','papel','plastico','vidro','eletronico','outros') NOT NULL,
  ...
  status ENUM('ativo','andamento','concluido','removido') DEFAULT 'ativo',
...
CREATE TABLE solicitacoes_coleta (
  ...
  status ENUM('pendente','confirmada','recusada','cancelada','concluida') DEFAULT 'pendente',
...
CREATE TABLE denuncias (
  ...
  usuario_id INT,        -- quem denunciou
  doacao_id INT,         -- qual postagem

  categoria ENUM('spam','ofensivo','fake','ilegal') NOT NULL,
